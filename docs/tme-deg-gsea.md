...
```
## [02:23:03] WARNING: src/learner.cc:1203: 
...
## 
## [02:23:03] WARNING: src/learner.cc:888: Found JSON model saved before XGBoost 1.6, please save the model using current version again. The support for old JSON model will be discontinued in XGBoost 2.3.
## [02:23:03] WARNING: src/learner.cc:553: 
##   If you are loading a serialized model (like pickle in Python, RDS in R) generated by
##   older XGBoost, please export the model by calling `Booster.save_model` from that version
##   first, then load it back in current version. See:
## 
...
##  [5] "CXCL9"          "WARS"           "IDO1"           "GBP4"          
##  [9] "GNLY"           "KLRC2"          "GZMH"           "VSNL1"         
## [13] "AIM2"           "SLCO1B3"        "KISS1R"         "TMEM100"       
## [17] "ADH1B"          "ABCA8"          "MAMDC2"         "SCN7A"         
## [21] "C7"             "C2orf40"        "LIPF"           "PGA4"          
## [25] "SCRG1"          "GHRL"           "OGN"            "GIF"           
## [29] "ATP4A"          "VIP"            "IL1A"           "EREG"          
## [33] "PPBP"           "IL11"           "PI15"           "IL24"          
## [37] "PROK2"          "CLEC5A"         "MAGEA10-MAGEA5" "MAGEA4"        
## [41] "MAGEA12"        "MAGEA6"         "MAGEA2B"        "REG1B"         
## [45] "CTAG1A"
```
