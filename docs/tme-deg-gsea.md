...
## [12:38:09] WARNING: amalgamation/../src/learner.cc:1040: 
...
## 
## [12:38:09] WARNING: amalgamation/../src/learner.cc:749: Found JSON model saved before XGBoost 1.6, please save the model using current version again. The support for old JSON model will be discontinued in XGBoost 2.3.
## >>>--- DONE!
```
...
## # ℹ 2 more variables: IA <dbl>, IE <dbl>
```
...
![](tme-deg-gsea_files/figure-epub3/unnamed-chunk-15-1.png)<!-- -->
...
![](tme-deg-gsea_files/figure-epub3/unnamed-chunk-19-1.png)<!-- -->
...
![](tme-deg-gsea_files/figure-epub3/unnamed-chunk-20-1.png)<!-- -->
...
![](tme-deg-gsea_files/figure-epub3/unnamed-chunk-22-1.png)<!-- -->
