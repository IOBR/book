...
## [12:44:41] WARNING: amalgamation/../src/learner.cc:1040: 
...
## 
## [12:44:41] WARNING: amalgamation/../src/learner.cc:749: Found JSON model saved before XGBoost 1.6, please save the model using current version again. The support for old JSON model will be discontinued in XGBoost 2.3.
## >>>--- DONE!
```
...
![](tme-deg-gsea_files/figure-epub3/unnamed-chunk-11-1.png)<!-- -->
...
![](tme-deg-gsea_files/figure-epub3/unnamed-chunk-16-1.png)<!-- -->
...
![](tme-deg-gsea_files/figure-epub3/unnamed-chunk-18-1.png)<!-- -->
